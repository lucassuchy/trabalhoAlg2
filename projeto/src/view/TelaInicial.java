...
public class TelaInicial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItemCategoriasCadastrar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemCategoriaCadastro(evt);
            }
        });
        jMenu6.add(jMenuItemCategoriasCadastrar);

        jMenuItemCategoriasListar.setText("Listar");
        jMenu6.add(jMenuItemCategoriasListar);
        ...
        jMenu7.add(jMenuItemProdutosCadastrar);
    ...
    private void jMenuItemCategoriaCadastro(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemCategoriaCadastro
            FrmCategoria tela = new FrmCategoria();
            jdpPainelInicial.add(tela);
            tela.setVisible(true);
        
    }//GEN-LAST:event_jMenuItemCategoriaCadastro
